...
// import net.danburfoot.shared.CrmUtil.*;
...
{ 
	...
	@SuppressWarnings("unchecked")
	public static <T> T smartunserialize(InputStream base) throws Exception
	{
		return (T) unserialize(base);
	}
	
	
	@SuppressWarnings("unchecked")
	public static <T> T smartunserialize(String path) throws Exception
	{
		return (T) unserialize(path);
	}
	

        public static void writeRowE(Writer mwrite, String delim, Collection<? extends Object> data)
        {
        	try { writeRow(mwrite, delim, data); }
	...
	public static ReaderUtil getReaderUtil()
	{
        ...
        public static class ReaderUtil 
        {
        	...
        	public ReaderUtil setGzip() throws IOException
        	{
        		Util.massert(_inStream != null, "Must set input stream first");
        		_inStream = new GZIPInputStream(_inStream);
        		return this;
        	}
